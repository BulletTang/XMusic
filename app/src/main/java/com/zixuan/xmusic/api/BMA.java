package com.zixuan.xmusic.api;

import com.zixuan.xmusic.utils.AESTools;
...
public class BMA {
    ...
    private static final String BASE_WEB = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=webapp_music&format=json";
    ...
    public static String focusPic(int num) {
        return BASE + "&method=" + "baidu.ting.plaza.getFocusPic" +
                "&num=" + num;
    }
    ...
    public static class Album {
        ...
        public static String recommendAlbum(int offset, int limmit) {
            return BASE + "&method=" + "baidu.ting.plaza.getRecommendAlbum" +
                    "&offset=" + offset +
                    "&limit=" + limmit;
        }
        ...
        public static String albumInfo(String albumid) {
            return BASE + "&method=" + "baidu.ting.album.getAlbumInfo" +
                    "&album_id=" + albumid;
        }
    }
...
//		}
    ...
    public static class Song {
        ...
        public static String songInfoFromWeb(String songid){
            return BASE_WEB + "&method=baidu.ting.song.playAAC&songid=" + songid;
        }
    ...
    public static class Artist {
        ...
        public static String artistInfo(String tinguid, String artistid) {
            return BASE + "&method=" + "baidu.ting.artist.getinfo" +
                    "&tinguid=" + tinguid +
                    "&artistid=" + artistid;
        }
    }
    ...
    public static class Billboard {
        ...
        public static String billCategory() {
            return BASE + "&method=" + "baidu.ting.billboard.billCategory" +
                    "&kflag=1";
        }
        ...
        public static String billSongList(int type, int offset, int size) {
            return BASE + "&method=" + "baidu.ting.billboard.billList" +
                    "&type=" + type +
                    "&offset=" + offset +
                    "&size=" + size +
                    "&fields=" + encode("song_id,title,author,album_title,pic_big,pic_small,havehigh,all_rate,charge,has_mv_mobile,learn,song_source,korean_bb_song");
        }
    }
    ...
    public static class GeDan {
        ...
        public static String geDan(int pageNo, int pageSize) {
            return BASE + "&method=" + "baidu.ting.diy.gedan" +
                    "&page_size=" + pageSize +
                    "&page_no=" + pageNo;
        }
        ...
        public static String geDanByTag(String tag, int pageNo, int pageSize) {
            return BASE + "&method=" + "baidu.ting.diy.search" +
                    "&page_size=" + pageSize +
                    "&page_no=" + pageNo +
                    "&query=" + encode(tag);
        }
        ...
        public static String geDanInfo(String listid) {
            return BASE + "&method=" + "baidu.ting.diy.gedanInfo" +
                    "&listid=" + listid;
        }
    }
    ...
    public static class Radio {
        ...
        public static String recChannel(int pageNo, int pageSize) {
            String sb = BASE + "&method=" + "baidu.ting.radio.getRecChannel" +
                    "&page_no=" + pageNo +
                    "&page_size=" + pageSize;
            return sb;
        }
        ...
        public static String recommendRadioList(int num) {
            return BASE + "&method=" + "baidu.ting.radio.getRecommendRadioList" +
                    "&num=" + num;
        }
    ...
    public static class Lebo {
        ...
        public static String channelTag(int pageNo, int pageSize) {
            ...
            return BASE + "&method=" + "baidu.ting.lebo.getChannelTag" +
                    "&page_no=" + pageNo +
        ...
        public static String channelSongList(String tagId, int num) {
            return BASE + "&method=" + "baidu.ting.lebo.channelSongList" +
                    "&tag_id=" + tagId +
                    "&num=" + num;
        }
    ...
    public static class Search {
        ...
        public static String searchSugestion(String query) {
            return BASE + "&method=" + "baidu.ting.search.catalogSug" +
                    "&query=" + encode(query);
        }
